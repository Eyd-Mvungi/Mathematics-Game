  ...
  for($i = 0; $i < $totalQuestions; $i++) {
    ...
    if ($countRight){
      ...
      $sql = "INSERT INTO `result`(`idscore`, `student_student_id`, `calculation_calculation_id`, `level_level_id`, `total_mark`, `grade`, `status`)
         VALUES ('','$data','2','2','$countRight','$grade','$status')";
...
<html lang="en" dir="ltr">
  ...
  <div id="redForm">
    ...
    <?php for($i=0; $i < $totalQuestions; $i++) {?>
      ...
      <li><?=$operand1[$i] . " - " . $operand2[$i] . " = " . $sub[$i] . ""?></li>
...
<button class="button button1" ><a href="nextpage/substratctionlevels.php" style="text-decoration: none;"> Perfom More substraction</a></button>
</div>

<div style="float:right;">
<button class="button button1" ><a href="../login/index.php" style="text-decoration: none;">HOME</a></button>
</div>
