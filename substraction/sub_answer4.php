  ...
  for($i = 0; $i < $totalQuestions; $i++) {
    ...
    if ($countRight){
      ...
      $sql = "INSERT INTO `result`(`idscore`, `student_student_id`, `calculation_calculation_id`, `level_level_id`, `total_mark`, `grade`, `status`)
         VALUES ('','$data','2','4','$countRight','$grade','$status')";
...
<html lang="en" dir="ltr">
  ...
  <div id="redForm">
    ...
    <?php for($i=0; $i < $totalQuestions; $i++) {?>
      ...
      <li><?=$operand1[$i] . " - " . $operand2[$i] . " - " . $operand3[$i] . " - " . $operand4[$i] . " = " . $sub[$i] . ""?></li>
...
<button class="button button1" ><a href="nextpage/indexsub.html" style="text-decoration: none;"> <h3>Perfom More substraction</h3></a></button>
</div>
