...
button {
  ...
  <body>
    ...
    <form id="regForm"  action="add_answer4.php" method ="POST" >


<h1>Attempt 50 Questions below:</h1>

  <?php

 for ($question = 1; $question <= 50; $question++){
    $num1 = rand(0,250000000);
    $num2 = rand(0,250000000);
    $num3 = rand(0,250000000);
    $num4 = rand(0,250000000);
...
<div class="tab">
  ...
  <h3><?= $question ." . ". $num1 ." + ". $num2 ." + ". $num3 ." + ". $num4 ." = "; ?></h3>
  <input type="hidden" value="<?=$num1?>" name="num1<?=$question?>">
  <input type="hidden" value="<?=$num2?>" name="num2<?=$question?>">
  <input type="hidden" value="<?=$num3?>" name="num3<?=$question?>">
  <input type="hidden" value="<?=$num4?>" name="num4<?=$question?>">
