...
button {
  ...
  <body>
    <div class="transbox">
    <form id="regForm" action="div_answer2.php" method ="POST">

<h1 style="text-align:center;">Attemp 20 Questions below:</h1><br>
...
<div class="tab">
  ...
  <input type="hidden" value="<?=$answer?>" name="answer<?=$question?>">
    ...
    <input type="decimal" id ="answers" name = "jibu<?=$question?>" placeholder="Answere here..." oninput="this.className = ''" required>
